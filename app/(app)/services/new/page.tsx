...
export default async function NewServicePage({ searchParams }: { searchParams: Promise<{ type?: string; clientId?: string }> }) {
  ...
  return (
    <div className="page-container">
      <h1 className="page-title mb-6">Nuevo {type === "RECURRING" ? "Recurrente" : "Único"}</h1>
