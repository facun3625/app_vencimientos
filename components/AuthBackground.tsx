// Shared decorative backdrop for the auth pages (login, register, forgot/reset
// password) — blurred gradient blobs + subtle grain + a dim veil, so the card
// on top reads as a modal floating over the page rather than a plain form.
